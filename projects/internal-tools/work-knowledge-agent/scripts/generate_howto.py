...
- Convert retrieved project knowledge into step-by-step procedures.
- Emit structured sections such as prerequisites, steps, validation, and sources.
...
def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Generate a structured how-to from indexed artifacts.")
	parser.add_argument("task", help="Task or procedure request")
