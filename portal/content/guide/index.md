...
Press <kbd>/</kbd> or <kbd>⌘K</kbd> from anywhere to search. Search covers
titles, descriptions, tags, and headings.

Every page also shows what it links to (**Related**) and what links back to it
(**Referenced by**), so you can traverse the graph rather than guessing at
folder names.

## Reading the signals on a page

Pages carry status information that tells you how much to trust them:

| Signal | Meaning |
|---|---|
| **Draft** banner | Work in progress. Unverified. Still worth reading, but check before acting on it |
| **Review overdue** banner | Past its review cycle. May describe how things used to work |
| **Archived** banner | Kept for history. Do not follow it |
| **Shareable** badge | Reviewed as safe to share outside the firm |

> [!NOTE]
> Drafts are visible on purpose. A half-written page that exists beats a perfect
> page that never gets written — the banner sets expectations honestly.
